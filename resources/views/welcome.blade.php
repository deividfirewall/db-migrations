                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    ...
                                    @if( $grupos[3]['backup'] === 1 )
                                        ...
                                        @endif
                                    @endif
                                    <p class="mb-4 text-sm/relaxed"> 1:t_sol_dias_gracias, 2:t_sol_almonedas, 3:t_sol_subastas, 4:t_subastas, 5:t_retasas, 6:t_vitrina_ventas, 7:t_vitrina_compras, 8:t_demasias_pagadas, 9:t_suspencion_dias, 10:  </p>
                                    <p class="mb-4 text-sm/relaxed text-black">Archivos unicos (Debido al tamaño) </p>
                                    <p class="mb-4 text-sm/relaxed"> h_boletas, t_boleta_pagos, t_cajas, t_ctrl_internos </p>
                                    <p class="mb-4 text-sm/relaxed text-black">Para base de datos (Central) </p>
                                    <p class="mb-4 text-sm/relaxed"> t_subasta_fechas </p>
                                </div>
                            </div>
                        </div>
                    </main>
